...
# as well as be within the desired year range.
    ...
    # search_venues(RO_VENUES,ARCHITECTURE_KWORDS + SAS_KWORDS)
    # search_venues(SA_VENUES,ROBOTICS_KWORDS + SAS_KWORDS)
    # search_venues(SAS_VENUES,ROBOTICS_KWORDS + ARCHITECTURE_KWORDS)
    print("")
